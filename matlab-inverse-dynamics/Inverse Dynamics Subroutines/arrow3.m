...
%   linewidth.
%
%   W (default = 1) is a vector of arrowhead widths.  H (default = 3W)
%   is a vector of arrowhead heights.  If vector IP is neither empty nor
%   negative, initial point markers will be plotted with diameter IP;
%   for default diameter W, use IP = 0.  The units of W, H and IP are
%   1/72 of the PlotBox diagonal.
%
...
%   particular, ARROW3 will not change XYZCLim or View.  ARROW3 does not,
%   however, support stretch-to-fill scaling.  AXIS NORMAL will restore
%   the current axis box to full size and remove any restrictions on the
%   scaling of units, but will likely result in distorted arrowheads and
...
%   Copyright(c)2002-2007 Version 5.001
